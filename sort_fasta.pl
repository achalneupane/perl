...
#Sort_fasta.pl -h to know more about script
#Sort_fasta.pl -r My_input     to sort fasta file in descending order
#Sort_fasta.pl -g My_input     remove gaps '-' from the sequence
#Sort_fasta.pl [options] My_input
